...
void MemoryTest(void)
{
    ...
    // Still need to ask start and end address
    while (1) {
    ...
    while (1) {
        ...
        if (end_address > 0x80030000 || end_address < start_address) {
    ...
    RamPtr = start_address;

    while(RamPtr > end_address) {
        // Write
        *RamPtr = 0x55555555;

        if(((unsigned int) RamPtr - start_address) % 40000 == 0){
            printf("Write up to %8x\n", RamPtr);
        }
    ...
    while(RamPtr > end_address){
        // Read
        if(*RamPtr != 0x55555555){
            printf("ERROR: address %8x, write value Ox55555555, read value %8x \n", RamPtr, *RamPtr);
        }
        
        if (((unsigned int) RamPtr - start_address) % 40000 == 0){
            printf("Read up to %8x\n", RamPtr);
        }
...
// Initialise Breakpoint variables
    ...
    // added lines
    printf("Sam (91469478) and Sandy (71623268)");
